...
echo "command: ./openos create-vote-account --commission 10 --keypair ~/.openos/identity.json --url https://api.mainnet.openverse.network ~/.openos/vote.json ~/.openos/identity.json ~/.openos/withdrawer.json"
